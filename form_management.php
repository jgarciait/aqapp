...
<script>
    ...
    <div class="container container-table">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form style="" class=""
                                    action="core/transactions/transacFormConnection.php?" 
                                    method="post"
                                    enctype="multipart/form-data">
                                <div class="mb-3">
                                    <label class="">Select Module Type</label>
                                    <select class="form-control" id="fm_workflows_id" name="fm_workflows_id">
                                        <option>---</option>
                                        <?php
                                    ...
                                    <div class="row">
                                        <div class="col" >
                                            <button type="submit" class="btn-menu btn-1 hover-filled-opacity"><span>Add Form Connection</span></button>
                                        </div>
                                    </div>
                                </form>
                            </div>
            ...
            <main class="container-fluid my-1 p-4 border border-info content-table bg-white shadow rounded table-responsive">
                <div>
                    <a href="#" class="btn-menu btn-1 hover-filled-opacity" id="openModal-1"><span>Add Form Connections</span></a>
                </div>
                <div>
                ...
                <div class="container-fluid p-3 mr-3 ">        
                    <table style="width: 100%; padding: 3rem;" id="templateTable" class="table table-bordered table-condensed table-hover">
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT *, form_metadata.id AS fmId
                            FROM form_metadata
                            ...
                            if ($result) {
                                ...
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    <tr>
                                        ...
                                        <td data-title='Nombre'><?php echo $row['workflow_name']?></td>
                                        <td data-title='Apellidos'><?php echo $row['table_name']?></td>
                                        <td data-title='Nombre de Usuario'><?php echo $row['form_name']?></td>
                                        <td data-title='Rol de Sistema'><?php echo $row['id']?></td>                 
                                        <td data-title='Opciones'>
                                            <?php echo '<a type="button" class="btn-menu-1 btn-1 hover-filled-opacity" href="viewAdminProfile.php?action=edit&id=' . $row['fmId'] . '"><span><i class="fa-solid fa-pen-to-square"></i></span></a>'; ?>
                                        </td>
                                        <td data-title='Borrar'>
                                            <?php echo '<a type="button" class="btn-menu-1 btn-1 hover-filled-opacity" href="javascript:void(0);" onclick="confirmDelete(' . $row['fmId'] . ');"><span><i class="fa-regular fa-trash-can"></i></span></a>'; ?>
                                        </td>
                                    </tr>
                                    <?php
                                    $count++;

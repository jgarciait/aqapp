    ...
    <div class="container-form my-2 mb-5 bg-white shadow rounded">
        ...
        <div style="width: 55em;" class="form-content p-3 m-2" id="regForm">
            ...
            <div>
                ...
                <button class="btn-menu btn-1 hover-filled-opacity" id="chatBtn" onclick="window.location.href='aqMessengerChatArea.php?workflow_id=<?php echo $senderId; ?>'">Chat with Sender</button>
            </div>

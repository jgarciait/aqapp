                    ...
                    <div class="modal fade" id="createProcess" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form class="shadow p-3" role="form" method="POST" action="transacWorkflowByArea.php?action=addWorkflowType.php" id="submitReport">
                                    <div>
                                    </div>
                                    <div class="mb-3">
                                    <label class="">Module - <?php echo $workflowName; ?></label>
                                        <input type="hidden" 
                                            class="form-control"
                                            name="wcreator_workflows_id"
                                            id="wcreator_workflows_id"
                                            value="<?php echo $wtypeId; ?>"
                                            >
                                    </div>
                                    <div class="mb-3">
                                    <label class="">Create Position</label>
                                        <input type="text" 
                                            class="form-control"
                                            name="wcreator_name"
                                            id="wcreator_name"
                                    ...
                                    <div class="mb-3">
                                        <label class="">Seleccione Nivel de Proceso</label>
                                        ...
                                        <input type="hidden" name="id" value="<?php echo $wtypeId; ?>">
                                    </div>
                                    <button type="submit" class="btn-menu btn-1 hover-filled-opacity"><span>Guardar</span></button>
                                    </form>
                                </div>
